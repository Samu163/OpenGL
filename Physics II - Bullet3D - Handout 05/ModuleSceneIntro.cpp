...
bool ModuleSceneIntro::Start()
{
	...
	AddCube({ -50 + 440 -5 + 130,120.01, 570 - 65-12-15 }, { 136, 15, 1.5 }, White, 0, 40, 0);
	...
	AddCube({ -50 + 440 + 200+35,120.01, 570 - 130 - 10+35 }, { 50, 15, 1.5 }, White, 0, 10, 0);
	AddCube({ -50 + 440 + 300,120.02, 570 - 130 }, { 200, 0, 45 }, Carretera, 0, 0, 0);
	AddCube({ -50 + 440 + 300,120.01, 570 - 150  }, { 200, 15, 1.5 }, White, 0, 0, 0);
	...
	AddCube({-30+  1373.7, 121.02, -5 }, { 3, 3, 3 }, Grey, 0, -10, 0);
	AddCube({ -30+ 1393.7, 121.01, -5 }, { 3, 3, 3 }, Grey, 0, -10, 0);
	AddCube({-30+  1383.7 ,121.02, 15 }, { 3, 3, 3 }, Grey, 0, -10, 0);

	AddCube({-30+  1358,  120.01, 88 }, { 30, 0, 100 }, Carretera, 0, -20, 0);
	AddCube({-30+  1348, 121.02, 88 }, { 3, 3, 3 }, Grey, 0, -20, 0);
	AddCube({-30+  1368, 121.01, 88 }, { 3, 3, 3 }, Grey, 0, -20, 0);
	AddCube({-30+  1358 , 121.02, 108 }, { 3, 3, 3 }, Grey, 0, -20, 0);

	AddCube({-30+  1317.2,120.01, 175}, { 30, 0, 100 }, Carretera, 0, -30, 0);
	AddCube({-30+  1307.2, 121.02, 175}, { 3, 3, 3 }, Grey, 0, -30, 0);
	AddCube({-30+  1327.2, 121.01, 175}, { 3, 3, 3 }, Grey, 0, -30, 0);
	AddCube({ -30+ 1317.2 , 121.02, 195 }, { 3, 3, 3 }, Grey, 0, -30, 0);

	AddCube({-30+  -120 + 782 + 600, 120.01, 453 - 200 }, { 30, 0, 100 }, Carretera, 0, -40, 0);
	AddCube({-30+  -120 + 782 + 600 - 10, 120.02 + 1, 453 - 200 }, { 3, 3, 3 }, Grey, 0, -40, 0);
	AddCube({-30+  -120 + 782 + 600 + 10, 120.01 + 1, 453 - 200 }, { 3, 3, 3 }, Grey, 0, -40, 0);
	AddCube({-30+  -120 + 782 + 600 , 120.02 + 1, 453 - 200 + 20 }, { 3, 3, 3 }, Grey, 0, -40, 0);

	AddCube({-30+  -188 + 782 + 600, 120.01, 520 - 200 }, { 30, 0, 100 }, Carretera, 0, -50, 0);
	AddCube({-30+  -188 + 782 + 600 - 10, 120.02 + 1, 520 - 200 }, { 3, 3, 3 }, Grey, 0, -50, 0);
	AddCube({-30+  -188 + 782 + 600 + 10, 120.01 + 1, 520 - 200 }, { 3, 3, 3 }, Grey, 0, -50, 0);
	AddCube({ -30+ -188 + 782 + 600 , 120.02 + 1, 520 - 200 + 20 }, { 3, 3, 3 }, Grey, 0, -50, 0);

	AddCube({-30+  -262 + 782 + 600, 120.01, 570 - 200 }, { 30, 0, 100 }, Carretera, 0, -60, 0);
	AddCube({-30+  -262 + 782 + 600 - 10, 120.02 + 1, 570 - 200 }, { 3, 3, 3 }, Grey, 0, -60, 0);
	AddCube({-30+  -262 + 782 + 600 + 10, 120.01 + 1, 570 - 200 }, { 3, 3, 3 }, Grey, 0, -60, 0);
	AddCube({-30+  -262 + 782 + 600 , 120.02 + 1, 570 - 200 + 20 }, { 3, 3, 3 }, Grey, 0, -60, 0);

	AddCube({-30+  -350 + 782 + 600, 120.01, 610 - 200 }, { 30, 0, 100 }, Carretera, 0, -70, 0);
	AddCube({-30+  -350 + 782 + 600 - 10, 120.02 + 1, 610 - 200 }, { 3, 3, 3 }, Grey, 0, -70, 0);
	AddCube({-30+  -350 + 782 + 600 + 10, 120.01 + 1, 610 - 200 }, { 3, 3, 3 }, Grey, 0, -70, 0);
	AddCube({-30+  -350 + 782 + 600 , 120.02 + 1, 610 - 200 + 20 }, { 3, 3, 3 }, Grey, 0, -70, 0);

	AddCube({-30+  -443 + 782 + 600, 120.01, 635 - 200 }, { 30, 0, 100 }, Carretera, 0, -80, 0);
	AddCube({-30+  -443 + 782 + 600 - 10, 120.02 + 1, 635 - 200 - 10 }, { 3, 3, 3 }, Grey, 0, -80, 0);
	AddCube({ -30+ -443 + 782 + 600 + 10, 120.01 + 1, 635 - 200 - 10 }, { 3, 3, 3 }, Grey, 0, -80, 0);
	AddCube({-30+  -443 + 782 + 600 , 120.02 + 1, 635 - 200 + 20 - 10 }, { 3, 3, 3 }, Grey, 0, -80, 0);
	...
	AddCube({ 1383,120.01,-225 }, { 47, 0, 166 }, Marron,0, 0, 0);
	...
	AddCube({ -50 + 440 + 300,120.01, 570 - 130 }, { 50, 0.1, 1.5 }, White, 0, 0, 0);



	AddCube({-30+  1383.7, 120.02,  -5 }, { 1.5, 0.1, 50 }, White, 0, -10, 0);
	

	AddCube({-30+  1358,  120.01, 88 }, { 1.5, 0.1, 50 }, White, 0, -20, 0);
	

	AddCube({-30+  1317.2,120.02, 175 }, { 1.5, 0.1, 50 }, White, 0, -30, 0);
	

	AddCube({-30+  -120 + 782 + 600, 120.01, 453 - 200 }, { 1.5, 0.1, 50 }, White, 0, -40, 0);
	

	AddCube({-30+  -188 + 782 + 600, 120.02, 520 - 200 }, { 1.5, 0.1, 50 }, White, 0, -50, 0);
	
	AddCube({-30+  -262 + 782 + 600, 120.01, 570 - 200 }, { 1.5, 0.1, 50 }, White, 0, -60, 0);
	

	//CheckPoints 
	
	AddCube({ 685-25, 80.02, 157.5 - 380 -200}, { 1.5, 15, 140 }, White, 0, 0, 0);
	AddCube({ 685+25, 80.01, 157.5 - 380 - 200 }, { 1.5, 15, 140 }, White, 0, 0, 0);
	AddCheckPoint({ 685, 80.02, 157.5 - 380 - 200 }, { 3, 3, 3 }, Red, 0, 0, 0);
	AddCheckPoint({ -50,80.01, 570 }, { 3, 3, 3 }, Red, 0, -70, 0);
	AddCube({ -50,80.02, 570-25 }, { 1.5, 15, 140 }, White, 0, -70, 0);
	AddCube({ -50,80.01, 570 + 25 }, { 1.5, 15, 140 }, White, 0, -70, 0);
	AddCheckPoint({ 1075,80.02, -715 }, { 3, 3, 3 }, Red, 0, -120, 0);
	AddCube({ 1075,80.01, -715 -25}, { 1.5, 15, 140 }, White, 0, -120, 0);
	AddCube({ 1075,80.02, -715 +25}, { 1.5, 15, 140 }, White, 0, -120, 0);
	AddCheckPoint({ 115,80.01, -715 }, { 3, 3, 3 }, Red, 0, -60, 0);
	AddCube({ 115,80.02, -715 -25}, { 1.5, 15, 140 }, White, 0, -60, 0);
	AddCube({ 115,80.01, -715 +25}, { 1.5, 15, 140 }, White, 0, -60, 0);
	AddCheckPoint({ 660,80.02, 297.5 }, { 3, 3, 3 }, Red, 0, -20, 0);
	AddCube({ 660-25,80.01, 297.5 }, { 1.5, 15, 140 }, White, 0, -20, 0);
	...
	//rampa-Curva
	AddCube({ 685,80.02, -455 }, { 1.5, 0.1, 50 }, White, 0, 0, 0);
	//Curva
	AddCube({ 710,80.01, -605 }, { 1.5, 0.1, 50 }, White, 0, -20, 0);
	AddCube({ 800,80.02, -715 }, { 1.5, 0.1, 50 }, White, 0, -60, 0);
	AddCube({ 940,80.01, -755 }, { 1.5, 0.1, 50 }, White, 0, -90, 0);
	AddCube({ 1075,80.02, -715 }, { 1.5, 0.1, 50 }, White, 0, -120, 0);
	...
	//fondo 
	AddCube({ 0,0, 0 }, { 8000, 0.1, 8000 }, Green, 0, 0, 0);

	//trofeo bordes
	AddCube({ 9 - 1500,82.02, 0 }, { 60, 2, 60 }, Purple, 0, 0, 0);
	AddCube({ 9 - 1500,82.02, 0+30 }, { 60, 9, 1.5 }, Blue, 0, 0, 0);
	AddCube({ 9 - 1500,82.02, 0-30 }, { 60, 20, 1.5 }, Blue, 0, 0, 0);
	AddCube({ 9 - 1500+30,82.02, 0 }, { 1.5, 30, 60 }, Blue, 0, 0, 0);
	AddCube({ 9 - 1500-30,82.02, 0 }, { 1.5, 30, 60 }, Blue, 0, 0, 0);
	...
	AddCube({ 9 - 1500,82.02+1000, 0 + 30 }, { 60, 9, 1.5 }, Blue, 0, 0, 0);
	AddCube({ 9 - 1500,82.02+1000, 0 - 30 }, { 60, 20, 1.5 }, Blue, 0, 0, 0);
	AddCube({ 9 - 1500 + 30,82.02+1000, 0 }, { 1.5, 30, 60 }, Blue, 0, 0, 0);
	AddCube({ 9 - 1500 - 30,82.02+1000, 0 }, { 1.5, 30, 60 }, Blue, 0, 0, 0);
